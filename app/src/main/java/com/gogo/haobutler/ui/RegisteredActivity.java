...
import com.gogo.haobutler.entity.User;

import cn.bmob.v3.exception.BmobException;
import cn.bmob.v3.listener.SaveListener;

import static com.gogo.haobutler.utils.Consts.USER_FEMALE;
import static com.gogo.haobutler.utils.Consts.USER_MALE;
...
public class RegisteredActivity extends BaseActivity {
    ...
    private class OnGenderListener implements RadioGroup.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            switch (checkedId) {
                case R.id.rb_male:
                    userGender = USER_MALE;
                    break;
                case R.id.rb_female:
                    userGender = USER_FEMALE;
                    break;
                default:
                    break;
            }
